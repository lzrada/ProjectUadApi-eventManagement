  ...
  return (
    <>
      <div className="min-h-screen bg-gray-100 flex flex-col">
        <section
          className="flex-1 flex items-center justify-center text-white bg-cover bg-center relative"
          style={{ backgroundImage: "url('/images/bg-konser.jpg')" }}
        >
          <div className="bg-black bg-opacity-50 absolute inset-0"></div>
          <div className="text-center p-8 z-10 relative">
            <h2 className="text-4xl font-bold mb-4">Welcome</h2>
            <p className="text-lg mb-6">
              By pressing the button below, you will be immediately directed to
              the login page!
            </p>
            <Link
              className="bg-transparent border-2 border-white text-white px-6 py-2 rounded-full font-medium shadow-md hover:bg-white hover:text-blue-500 transition-colors"
              href="/login"
            >
              Get Started
            </Link>
          ...
          <div className="absolute top-6 left-6">
            <img
              src="/images/logo epep.png"
              alt="Logo"
              className="w-30 h-10 shadow-md"
            />
          </div>
      ...
      <div id="next-section" className="bg-white w-full px-8 py-6">
            ...
            {eventList.map((event) => (
              <li key={event.id} className="bg-gray-100 p-4 rounded shadow">
                <img
                  ...
                  onClick={() => openModal(event.image || "/placeholder.png")}
                />
                <p className="mt-2 text-gray-700 font-bold">
                  {event.title || "Untitled Event"}
                </p>
                <p className="mt-2 text-gray-700 ">
                  {event.description || "Untitled description"}
                </p>
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300">
              <a
                href="https://maps.app.goo.gl/BP4t3vgqKNjZhJ9D7"
                target="_blank"
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.instagram.com/adeee_ptra/profilecard/?igsh=MTR3eGJybXpudDB2cA=="
                target="_blank"
                rel="noopener noreferrer"
